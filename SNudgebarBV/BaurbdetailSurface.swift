...
final class BaurbdetailSurface: barbCanvasbarBV {
    ...
    private func configureHeaderbarBV() {
        ...
        headerTitlebarBV.font = BaurbstyleStorebarBV.fontbarBV(28, weight: .heavy)
    ...
    private func configureScrollbarBV() {
        ...
        NSLayoutConstraint.activate([
            scrollViewbarBV.topAnchor.constraint(equalTo: headerBarbarBV.bottomAnchor, constant: BaurbstyleStorebarBV.spacebarBV(18, minimumbarBV: 10, maximumbarBV: 22)),
            ...
            stackbarBV.bottomAnchor.constraint(equalTo: contentViewbarBV.bottomAnchor, constant: -BaurbstyleStorebarBV.spacebarBV(28, minimumbarBV: 20, maximumbarBV: 34))
        ])
    }

    private func configureProfileCardbarBV() {
        let cardbarBV = cardSurfacebarBV(cornerRadius: BaurbstyleStorebarBV.metricbarBV(28, minimumbarBV: 24, maximumbarBV: 32))
        avatarbarBV.font = BaurbstyleStorebarBV.fontbarBV(50, weight: .bold)
        nameLabelbarBV.font = BaurbstyleStorebarBV.fontbarBV(28, weight: .heavy)
        ...
        idLabelbarBV.font = BaurbstyleStorebarBV.fontbarBV(15, weight: .semibold)
        idLabelbarBV.textColor = BaurbstyleStorebarBV.mutedText
        idLabelbarBV.textAlignment = .center
        BaurbstyleStorebarBV.labelFitbarBV(idLabelbarBV, factorbarBV: 0.72, linesbarBV: 1)
        ...
        messageButtonbarBV.titleLabel?.font = BaurbstyleStorebarBV.fontbarBV(18, weight: .heavy)
        messageButtonbarBV.colorsbarBV = BaurbstyleStorebarBV.replyChoiceColorsbarBV
        messageButtonbarBV.locationsbarBV = BaurbstyleStorebarBV.replyChoiceLocationsbarBV
        ...
        let avatarSizebarBV = BaurbstyleStorebarBV.metricbarBV(94, minimumbarBV: 78, maximumbarBV: 100)
        NSLayoutConstraint.activate([
            cardbarBV.heightAnchor.constraint(equalToConstant: BaurbstyleStorebarBV.metricbarBV(254, minimumbarBV: 226, maximumbarBV: 274)),
            avatarbarBV.topAnchor.constraint(equalTo: cardbarBV.topAnchor, constant: BaurbstyleStorebarBV.spacebarBV(28, minimumbarBV: 20, maximumbarBV: 34)),
            ...
            nameLabelbarBV.topAnchor.constraint(equalTo: avatarbarBV.bottomAnchor, constant: BaurbstyleStorebarBV.spacebarBV(18, minimumbarBV: 12, maximumbarBV: 20)),
            nameLabelbarBV.leadingAnchor.constraint(equalTo: cardbarBV.leadingAnchor, constant: BaurbstyleStorebarBV.metricbarBV(18, minimumbarBV: 14, maximumbarBV: 22)),
            nameLabelbarBV.trailingAnchor.constraint(equalTo: cardbarBV.trailingAnchor, constant: -BaurbstyleStorebarBV.metricbarBV(18, minimumbarBV: 14, maximumbarBV: 22)),

            idLabelbarBV.topAnchor.constraint(equalTo: nameLabelbarBV.bottomAnchor, constant: BaurbstyleStorebarBV.spacebarBV(6, minimumbarBV: 4, maximumbarBV: 8)),
            ...
            messageButtonbarBV.topAnchor.constraint(equalTo: idLabelbarBV.bottomAnchor, constant: BaurbstyleStorebarBV.spacebarBV(16, minimumbarBV: 10, maximumbarBV: 18)),
            messageButtonbarBV.centerXAnchor.constraint(equalTo: cardbarBV.centerXAnchor),
            messageButtonbarBV.widthAnchor.constraint(equalToConstant: BaurbstyleStorebarBV.metricbarBV(150, minimumbarBV: 132, maximumbarBV: 164)),
            messageButtonbarBV.heightAnchor.constraint(equalToConstant: BaurbstyleStorebarBV.controlbarBV(46))
        ])
    }
    ...
    private func configureInfoSectionsbarBV() {
        ...
        muteSwitchbarBV.onTintColor = BaurbstyleStorebarBV.purple
        pinSwitchbarBV.onTintColor = BaurbstyleStorebarBV.purple
    ...
    private func configureActionButtonsbarBV() {
        ...
        removeButtonbarBV.titleLabel?.font = BaurbstyleStorebarBV.fontbarBV(20, weight: .heavy)
        ...
        blockButtonbarBV.titleLabel?.font = BaurbstyleStorebarBV.fontbarBV(20, weight: .heavy)
        blockButtonbarBV.backgroundColor = UIColor.white.withAlphaComponent(0.96)
        blockButtonbarBV.layer.cornerRadius = BaurbstyleStorebarBV.controlbarBV(58) / 2
        ...
        spacerbarBV.heightAnchor.constraint(equalToConstant: BaurbstyleStorebarBV.spacebarBV(4, minimumbarBV: 0, maximumbarBV: 8)).isActive = true
        ...
        removeButtonbarBV.heightAnchor.constraint(equalToConstant: BaurbstyleStorebarBV.controlbarBV(58)).isActive = true
        blockButtonbarBV.heightAnchor.constraint(equalToConstant: BaurbstyleStorebarBV.controlbarBV(58)).isActive = true
    }
    ...
    private func groupedCardbarBV(_ rowsbarBV: [UIView]) -> UIView {
        ...
        for (indexbarBV, rowbarBV) in rowsbarBV.enumerated() {
            ...
            rowbarBV.heightAnchor.constraint(greaterThanOrEqualToConstant: BaurbstyleStorebarBV.metricbarBV(72, minimumbarBV: 62, maximumbarBV: 78)).isActive = true
...
private final class profileValueRowbarBV: UIView {
    init(titlebarBV: String, valuebarBV: String, chevronbarBV: Bool) {
        ...
        valueLabelbarBV.font = BaurbstyleStorebarBV.fontbarBV(16, weight: .regular)
        ...
        NSLayoutConstraint.activate([
            titleLabelbarBV.leadingAnchor.constraint(equalTo: leadingAnchor, constant: BaurbstyleStorebarBV.metricbarBV(28, minimumbarBV: 20, maximumbarBV: 30)),
            titleLabelbarBV.centerYAnchor.constraint(equalTo: centerYAnchor),
            titleLabelbarBV.trailingAnchor.constraint(lessThanOrEqualTo: valueLabelbarBV.leadingAnchor, constant: -BaurbstyleStorebarBV.metricbarBV(12, minimumbarBV: 8, maximumbarBV: 14)),

            chevronViewbarBV.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -BaurbstyleStorebarBV.metricbarBV(28, minimumbarBV: 20, maximumbarBV: 30)),
            chevronViewbarBV.centerYAnchor.constraint(equalTo: centerYAnchor),
            chevronViewbarBV.widthAnchor.constraint(equalToConstant: BaurbstyleStorebarBV.metricbarBV(16, minimumbarBV: 14, maximumbarBV: 18)),
            ...
            valueLabelbarBV.trailingAnchor.constraint(equalTo: chevronbarBV ? chevronViewbarBV.leadingAnchor : trailingAnchor, constant: chevronbarBV ? -BaurbstyleStorebarBV.metricbarBV(12, minimumbarBV: 8, maximumbarBV: 14) : -BaurbstyleStorebarBV.metricbarBV(28, minimumbarBV: 20, maximumbarBV: 30)),
...
private final class profileSwitchRowbarBV: UIView {
    init(titlebarBV: String, switchbarBV: UISwitch) {
        ...
        labelbarBV.font = BaurbstyleStorebarBV.fontbarBV(18, weight: .semibold)
        labelbarBV.textColor = .black
        ...
        NSLayoutConstraint.activate([
            labelbarBV.leadingAnchor.constraint(equalTo: leadingAnchor, constant: BaurbstyleStorebarBV.metricbarBV(28, minimumbarBV: 20, maximumbarBV: 30)),
            labelbarBV.centerYAnchor.constraint(equalTo: centerYAnchor),
            labelbarBV.trailingAnchor.constraint(lessThanOrEqualTo: switchbarBV.leadingAnchor, constant: -BaurbstyleStorebarBV.metricbarBV(12, minimumbarBV: 8, maximumbarBV: 14)),
            switchbarBV.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -BaurbstyleStorebarBV.metricbarBV(26, minimumbarBV: 20, maximumbarBV: 30)),
