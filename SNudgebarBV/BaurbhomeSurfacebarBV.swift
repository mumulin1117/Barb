...
final class BaurbhomeSurfacebarBV: barbCanvasbarBV, UITextViewDelegate {
    ...
    private func layoutFlowbarBV() {
        ...
        stackSurfacebarBV.spacing = BaurbstyleStorebarBV.spacebarBV(18, minimumbarBV: 14, maximumbarBV: 22)
        ...
        NSLayoutConstraint.activate([
            ...
            stackSurfacebarBV.topAnchor.constraint(equalTo: scrollSurfacebarBV.contentLayoutGuide.topAnchor, constant: BaurbstyleStorebarBV.spacebarBV(28, minimumbarBV: 16, maximumbarBV: 38)),
            ...
            stackSurfacebarBV.bottomAnchor.constraint(equalTo: scrollSurfacebarBV.contentLayoutGuide.bottomAnchor, constant: -BaurbstyleStorebarBV.spacebarBV(22, minimumbarBV: 16, maximumbarBV: 24))
        ])
    }
    ...
    private func headerSurfacebarBV() -> UIView {
        ...
        markSurfacebarBV.font = BaurbstyleStorebarBV.italicFontbarBV(32)
        markSurfacebarBV.textColor = .black
        BaurbstyleStorebarBV.labelFitbarBV(markSurfacebarBV, factorbarBV: 0.78, linesbarBV: 1)
        ...
        badgeSurfacebarBV.font = BaurbstyleStorebarBV.fontbarBV(10, weight: .heavy)
        ...
        let avatarSurfacebarBV = avatarSurfacebarBV(initial: BaurbsessionStore.profileSnapshotbarBV?.placeholderAvatar ?? "B", color: BaurbstyleStorebarBV.pink)
        ...
        let toolSizebarBV = BaurbstyleStorebarBV.controlbarBV(46)
        let badgeSizebarBV = BaurbstyleStorebarBV.metricbarBV(18, minimumbarBV: 16, maximumbarBV: 18)
        NSLayoutConstraint.activate([
            rowSurfacebarBV.heightAnchor.constraint(equalToConstant: BaurbstyleStorebarBV.metricbarBV(54, minimumbarBV: 48, maximumbarBV: 58)),
    ...
    private func summarySurfacebarBV() -> UIView {
        ...
        BaurbstyleStorebarBV.labelFitbarBV(labelSurfacebarBV, factorbarBV: 0.52, linesbarBV: labelSurfacebarBV.numberOfLines)
        ...
        if unreadCounterbarBV == 0 {
            ...
            NSLayoutConstraint.activate([
                cardSurfacebarBV.heightAnchor.constraint(equalToConstant: BaurbstyleStorebarBV.metricbarBV(78, minimumbarBV: 68, maximumbarBV: 86)),
        ...
        contentRowbarBV.spacing = BaurbstyleStorebarBV.metricbarBV(10, minimumbarBV: 6, maximumbarBV: 12)
        cardSurfacebarBV.addSubview(contentRowbarBV)
        contentRowbarBV.translatesAutoresizingMaskIntoConstraints = false
        NSLayoutConstraint.activate([
            cardSurfacebarBV.heightAnchor.constraint(equalToConstant: BaurbstyleStorebarBV.metricbarBV(78, minimumbarBV: 68, maximumbarBV: 86)),
            contentRowbarBV.leadingAnchor.constraint(equalTo: cardSurfacebarBV.leadingAnchor, constant: BaurbstyleStorebarBV.metricbarBV(20, minimumbarBV: 14, maximumbarBV: 22)),
            contentRowbarBV.trailingAnchor.constraint(equalTo: cardSurfacebarBV.trailingAnchor, constant: -BaurbstyleStorebarBV.metricbarBV(20, minimumbarBV: 14, maximumbarBV: 22)),
    ...
    private func summaryTextbarBV(unreadCounterbarBV: Int) -> NSAttributedString {
        if unreadCounterbarBV == 0 {
            return NSAttributedString(
                ...
                attributes: [.font: BaurbstyleStorebarBV.fontbarBV(17, weight: .heavy), .foregroundColor: UIColor.black]
            )
        }
        let textSurfacebarBV = NSMutableAttributedString(
            string: "\(unreadCounterbarBV)",
            attributes: [.font: BaurbstyleStorebarBV.titleFont(24), .foregroundColor: BaurbstyleStorebarBV.blue]
        )
    ...
    private func waitingSurfacebarBV(_ threadFlowbarBV: threadFixturebarBV) -> UIView {
        ...
        tagSurfacebarBV.textColor = BaurbstyleStorebarBV.pink
        ...
        tagSurfacebarBV.font = BaurbstyleStorebarBV.fontbarBV(16, weight: .bold)
        BaurbstyleStorebarBV.labelFitbarBV(tagSurfacebarBV, factorbarBV: 0.68, linesbarBV: 1)
        let timeSurfacebarBV = UILabel()
        timeSurfacebarBV.text = "Today 9:30"
        timeSurfacebarBV.textAlignment = .right
        timeSurfacebarBV.font = BaurbstyleStorebarBV.fontbarBV(16, weight: .heavy)
        BaurbstyleStorebarBV.labelFitbarBV(timeSurfacebarBV, factorbarBV: 0.7, linesbarBV: 1)
        ...
        let avatarSurfacebarBV = avatarSurfacebarBV(initial: contactbarBV?.placeholderAvatar ?? "M", color: BaurbstyleStorebarBV.purple)
        let nameSurfacebarBV = UILabel()
        nameSurfacebarBV.text = threadFlowbarBV.threadTitlebarBV
        nameSurfacebarBV.font = BaurbstyleStorebarBV.fontbarBV(25, weight: .heavy)
        BaurbstyleStorebarBV.labelFitbarBV(nameSurfacebarBV, factorbarBV: 0.72, linesbarBV: 1)
        ...
        noteSurfacebarBV.font = BaurbstyleStorebarBV.fontbarBV(18, weight: .regular)
        BaurbstyleStorebarBV.labelFitbarBV(noteSurfacebarBV, factorbarBV: 0.74, linesbarBV: 2)
        ...
        textSurfacebarBV.font = BaurbstyleStorebarBV.fontbarBV(22, weight: .regular)
        ...
        laterButtonbarBV.titleLabel?.font = BaurbstyleStorebarBV.fontbarBV(23, weight: .heavy)
        BaurbstyleStorebarBV.buttonFitbarBV(laterButtonbarBV)
        ...
        nameStackbarBV.spacing = BaurbstyleStorebarBV.spacebarBV(4, minimumbarBV: 3, maximumbarBV: 5)
        ...
        profileRowbarBV.spacing = BaurbstyleStorebarBV.metricbarBV(12, minimumbarBV: 10, maximumbarBV: 14)
        ...
        contentStackbarBV.spacing = BaurbstyleStorebarBV.spacebarBV(18, minimumbarBV: 14, maximumbarBV: 20)
        ...
        let avatarSizebarBV = BaurbstyleStorebarBV.metricbarBV(62, minimumbarBV: 52, maximumbarBV: 68)
        let buttonHeightbarBV = BaurbstyleStorebarBV.controlbarBV(54)
        NSLayoutConstraint.activate([
            shellSurfacebarBV.heightAnchor.constraint(greaterThanOrEqualToConstant: BaurbstyleStorebarBV.spacebarBV(430, minimumbarBV: 360, maximumbarBV: 500)),
            ...
            haloSurfacebarBV.heightAnchor.constraint(equalToConstant: BaurbstyleStorebarBV.metricbarBV(96, minimumbarBV: 76, maximumbarBV: 112)),
            layerSurfacebarBV.topAnchor.constraint(equalTo: shellSurfacebarBV.topAnchor, constant: BaurbstyleStorebarBV.spacebarBV(72, minimumbarBV: 54, maximumbarBV: 84)),
            layerSurfacebarBV.leadingAnchor.constraint(equalTo: shellSurfacebarBV.leadingAnchor, constant: BaurbstyleStorebarBV.metricbarBV(28, minimumbarBV: 18, maximumbarBV: 34)),
            layerSurfacebarBV.trailingAnchor.constraint(equalTo: shellSurfacebarBV.trailingAnchor),
            layerSurfacebarBV.bottomAnchor.constraint(equalTo: shellSurfacebarBV.bottomAnchor, constant: -BaurbstyleStorebarBV.spacebarBV(42, minimumbarBV: 30, maximumbarBV: 50)),
            cardSurfacebarBV.topAnchor.constraint(equalTo: shellSurfacebarBV.topAnchor, constant: BaurbstyleStorebarBV.spacebarBV(48, minimumbarBV: 34, maximumbarBV: 56)),
            ...
            topStripbarBV.heightAnchor.constraint(equalToConstant: BaurbstyleStorebarBV.metricbarBV(62, minimumbarBV: 54, maximumbarBV: 72)),
            tagSurfacebarBV.leadingAnchor.constraint(equalTo: topStripbarBV.leadingAnchor, constant: BaurbstyleStorebarBV.metricbarBV(22, minimumbarBV: 14, maximumbarBV: 30)),
            ...
            timeSurfacebarBV.trailingAnchor.constraint(equalTo: topStripbarBV.trailingAnchor, constant: -BaurbstyleStorebarBV.metricbarBV(22, minimumbarBV: 14, maximumbarBV: 30)),
            ...
            contentStackbarBV.topAnchor.constraint(equalTo: topStripbarBV.bottomAnchor, constant: BaurbstyleStorebarBV.spacebarBV(26, minimumbarBV: 18, maximumbarBV: 34)),
            contentStackbarBV.leadingAnchor.constraint(equalTo: cardSurfacebarBV.leadingAnchor, constant: BaurbstyleStorebarBV.metricbarBV(24, minimumbarBV: 18, maximumbarBV: 28)),
            contentStackbarBV.trailingAnchor.constraint(equalTo: cardSurfacebarBV.trailingAnchor, constant: -BaurbstyleStorebarBV.metricbarBV(24, minimumbarBV: 18, maximumbarBV: 28)),
            contentStackbarBV.bottomAnchor.constraint(equalTo: cardSurfacebarBV.bottomAnchor, constant: -BaurbstyleStorebarBV.spacebarBV(32, minimumbarBV: 24, maximumbarBV: 40)),
    ...
    private func draftSurfacebarBV(_ threadFlowbarBV: threadFixturebarBV) -> UIView {
        ...
        lineSurfacebarBV.backgroundColor = BaurbstyleStorebarBV.blue
        let metaSurfacebarBV = UILabel()
        metaSurfacebarBV.text = "↳ REPLYING TO \(threadFlowbarBV.threadTitlebarBV.uppercased()) · 11:24"
        metaSurfacebarBV.textColor = BaurbstyleStorebarBV.blue
        metaSurfacebarBV.font = BaurbstyleStorebarBV.fontbarBV(12, weight: .heavy)
        BaurbstyleStorebarBV.labelFitbarBV(metaSurfacebarBV, factorbarBV: 0.68, linesbarBV: 1)
        let quoteSurfacebarBV = UILabel()
        quoteSurfacebarBV.text = "\"\(latestbarBV?.messageCopybarBV ?? "")\""
        quoteSurfacebarBV.font = BaurbstyleStorebarBV.fontbarBV(17, weight: .regular)
        ...
        draftLabelbarBV.font = BaurbstyleStorebarBV.fontbarBV(16, weight: .heavy)
        BaurbstyleStorebarBV.labelFitbarBV(draftLabelbarBV, factorbarBV: 0.68, linesbarBV: 1)
        ...
        toneSurfacebarBV.font = BaurbstyleStorebarBV.fontbarBV(18, weight: .heavy)
        BaurbstyleStorebarBV.labelFitbarBV(toneSurfacebarBV, factorbarBV: 0.68, linesbarBV: 1)
        toneSurfacebarBV.backgroundColor = BaurbstyleStorebarBV.pink
        ...
        unlockSurfacebarBV.font = BaurbstyleStorebarBV.fontbarBV(16, weight: .heavy)
        BaurbstyleStorebarBV.labelFitbarBV(unlockSurfacebarBV, factorbarBV: 0.68, linesbarBV: 1)
        ...
        entrySurfacebarBV.font = BaurbstyleStorebarBV.fontbarBV(draftTextbarBV.isEmpty ? 21 : 22, weight: .regular)
        ...
        sendButtonbarBV.titleLabel?.font = BaurbstyleStorebarBV.fontbarBV(20, weight: .heavy)
        BaurbstyleStorebarBV.buttonFitbarBV(sendButtonbarBV)
        ...
        stackDraftbarBV.spacing = BaurbstyleStorebarBV.spacebarBV(18, minimumbarBV: 14, maximumbarBV: 22)
        shellSurfacebarBV.addSubview(haloSurfacebarBV)
        shellSurfacebarBV.addSubview(layerSurfacebarBV)
        shellSurfacebarBV.addSubview(cardSurfacebarBV)
        ...
        let actionHeightbarBV = BaurbstyleStorebarBV.controlbarBV(54)
        NSLayoutConstraint.activate([
            shellSurfacebarBV.heightAnchor.constraint(greaterThanOrEqualToConstant: BaurbstyleStorebarBV.spacebarBV(540, minimumbarBV: 460, maximumbarBV: 610)),
            haloSurfacebarBV.topAnchor.constraint(equalTo: shellSurfacebarBV.topAnchor),
            haloSurfacebarBV.leadingAnchor.constraint(equalTo: shellSurfacebarBV.leadingAnchor),
            haloSurfacebarBV.trailingAnchor.constraint(equalTo: shellSurfacebarBV.trailingAnchor),
            haloSurfacebarBV.heightAnchor.constraint(equalToConstant: BaurbstyleStorebarBV.metricbarBV(96, minimumbarBV: 76, maximumbarBV: 112)),
            ...
            cardSurfacebarBV.trailingAnchor.constraint(equalTo: shellSurfacebarBV.trailingAnchor),
            cardSurfacebarBV.bottomAnchor.constraint(equalTo: shellSurfacebarBV.bottomAnchor),
            stackDraftbarBV.topAnchor.constraint(equalTo: cardSurfacebarBV.topAnchor, constant: BaurbstyleStorebarBV.spacebarBV(46, minimumbarBV: 32, maximumbarBV: 56)),
            stackDraftbarBV.leadingAnchor.constraint(equalTo: cardSurfacebarBV.leadingAnchor, constant: BaurbstyleStorebarBV.metricbarBV(22, minimumbarBV: 16, maximumbarBV: 24)),
            stackDraftbarBV.trailingAnchor.constraint(equalTo: cardSurfacebarBV.trailingAnchor, constant: -BaurbstyleStorebarBV.metricbarBV(22, minimumbarBV: 16, maximumbarBV: 24)),
            stackDraftbarBV.bottomAnchor.constraint(equalTo: cardSurfacebarBV.bottomAnchor, constant: -BaurbstyleStorebarBV.spacebarBV(30, minimumbarBV: 22, maximumbarBV: 36)),
            headerSurfacebarBV.heightAnchor.constraint(greaterThanOrEqualToConstant: BaurbstyleStorebarBV.metricbarBV(100, minimumbarBV: 88, maximumbarBV: 112)),
            ...
            lineSurfacebarBV.widthAnchor.constraint(equalToConstant: BaurbstyleStorebarBV.metricbarBV(3, minimumbarBV: 2, maximumbarBV: 3)),
            metaSurfacebarBV.leadingAnchor.constraint(equalTo: headerSurfacebarBV.leadingAnchor, constant: BaurbstyleStorebarBV.metricbarBV(20, minimumbarBV: 16, maximumbarBV: 24)),
            metaSurfacebarBV.topAnchor.constraint(equalTo: headerSurfacebarBV.topAnchor, constant: BaurbstyleStorebarBV.spacebarBV(18, minimumbarBV: 14, maximumbarBV: 22)),
            ...
            quoteSurfacebarBV.topAnchor.constraint(equalTo: metaSurfacebarBV.bottomAnchor, constant: BaurbstyleStorebarBV.spacebarBV(10, minimumbarBV: 8, maximumbarBV: 12)),
            ...
            draftBadgebarBV.widthAnchor.constraint(equalToConstant: BaurbstyleStorebarBV.metricbarBV(124, minimumbarBV: 108, maximumbarBV: 132)),
            draftBadgebarBV.heightAnchor.constraint(equalToConstant: BaurbstyleStorebarBV.controlbarBV(42)),
            ...
            toneSurfacebarBV.heightAnchor.constraint(equalToConstant: BaurbstyleStorebarBV.controlbarBV(44)),
            toneSurfacebarBV.widthAnchor.constraint(equalToConstant: BaurbstyleStorebarBV.metricbarBV(124, minimumbarBV: 104, maximumbarBV: 136)),
            entrySurfacebarBV.heightAnchor.constraint(greaterThanOrEqualToConstant: BaurbstyleStorebarBV.metricbarBV(draftTextbarBV.isEmpty ? 108 : 136, minimumbarBV: draftTextbarBV.isEmpty ? 96 : 120, maximumbarBV: draftTextbarBV.isEmpty ? 118 : 150)),
    ...
    private func styleSurfacebarBV() -> UIView {
        ...
        titleSurfacebarBV.font = BaurbstyleStorebarBV.fontbarBV(18, weight: .heavy)
        titleSurfacebarBV.textColor = .black
        BaurbstyleStorebarBV.labelFitbarBV(titleSurfacebarBV, factorbarBV: 0.68, linesbarBV: 1)
        ...
        rowSurfacebarBV.spacing = BaurbstyleStorebarBV.metricbarBV(10, minimumbarBV: 8, maximumbarBV: 12)
        ...
        let botSizebarBV = BaurbstyleStorebarBV.metricbarBV(38, minimumbarBV: 34, maximumbarBV: 40)
        NSLayoutConstraint.activate([
            cardSurfacebarBV.heightAnchor.constraint(equalToConstant: BaurbstyleStorebarBV.metricbarBV(130, minimumbarBV: 118, maximumbarBV: 142)),
            stackbarBV.topAnchor.constraint(equalTo: cardSurfacebarBV.topAnchor, constant: BaurbstyleStorebarBV.spacebarBV(18, minimumbarBV: 14, maximumbarBV: 20)),
            stackbarBV.leadingAnchor.constraint(equalTo: cardSurfacebarBV.leadingAnchor, constant: BaurbstyleStorebarBV.metricbarBV(18, minimumbarBV: 14, maximumbarBV: 20)),
            stackbarBV.trailingAnchor.constraint(equalTo: cardSurfacebarBV.trailingAnchor, constant: -BaurbstyleStorebarBV.metricbarBV(18, minimumbarBV: 14, maximumbarBV: 20)),
            rowSurfacebarBV.heightAnchor.constraint(equalToConstant: BaurbstyleStorebarBV.controlbarBV(50)),
            ...
            entrySurfacebarBV.widthAnchor.constraint(equalToConstant: BaurbstyleStorebarBV.metricbarBV(30, minimumbarBV: 28, maximumbarBV: 32)),
            entrySurfacebarBV.heightAnchor.constraint(equalToConstant: BaurbstyleStorebarBV.metricbarBV(30, minimumbarBV: 28, maximumbarBV: 32))
        ])
        return cardSurfacebarBV
    }
    ...
    private func styleButtonbarBV(_ tonebarBV: replyStylebarBV) -> UIButton {
        ...
        if let choiceSurfacebarBV = buttonSurfacebarBV as? gradientPill {
            choiceSurfacebarBV.colorsbarBV = BaurbstyleStorebarBV.replyChoiceColorsbarBV
            choiceSurfacebarBV.locationsbarBV = BaurbstyleStorebarBV.replyChoiceLocationsbarBV
            choiceSurfacebarBV.cornerRadiusbarBV = 16
        }
        buttonSurfacebarBV.setTitle(tonebarBV.rawValue, for: .normal)
        buttonSurfacebarBV.titleLabel?.font = BaurbstyleStorebarBV.fontbarBV(tonesNeedCompactbarBV() ? 16 : 20, weight: .heavy)
        BaurbstyleStorebarBV.buttonFitbarBV(buttonSurfacebarBV, factorbarBV: 0.68)
    ...
    private func emptySurfacebarBV() -> UIView {
        ...
        textSurfacebarBV.font = BaurbstyleStorebarBV.fontbarBV(20, weight: .heavy)
        textSurfacebarBV.textAlignment = .center
        textSurfacebarBV.numberOfLines = 2
        BaurbstyleStorebarBV.labelFitbarBV(textSurfacebarBV, factorbarBV: 0.7, linesbarBV: 0)
        cardSurfacebarBV.addSubview(textSurfacebarBV)
        textSurfacebarBV.translatesAutoresizingMaskIntoConstraints = false
        NSLayoutConstraint.activate([
            cardSurfacebarBV.heightAnchor.constraint(equalToConstant: BaurbstyleStorebarBV.metricbarBV(150, minimumbarBV: 120, maximumbarBV: 180)),
    ...
    private func plainButtonbarBV(_ titlebarBV: String, borderbarBV: Bool) -> UIButton {
        ...
        buttonSurfacebarBV.titleLabel?.font = BaurbstyleStorebarBV.fontbarBV(19, weight: .bold)
        BaurbstyleStorebarBV.buttonFitbarBV(buttonSurfacebarBV)
    ...
    private func cardStripbarBV() -> gradientBadgebarBV {
        ...
        stripSurfacebarBV.colorsbarBV = BaurbstyleStorebarBV.cardStripColorsbarBV
        stripSurfacebarBV.locationsbarBV = BaurbstyleStorebarBV.cardStripLocationsbarBV
...
final class gradientBadgebarBV: UIView {
    var colorsbarBV: [UIColor] = [BaurbstyleStorebarBV.mint, BaurbstyleStorebarBV.purple, BaurbstyleStorebarBV.pink] {
        didSet { refreshbarBV() }
    }
...
private final class homeSearchSurfacebarBV: barbCanvasbarBV, UITextFieldDelegate {
    ...
    private func configureSurfacebarBV() {
        ...
        NSLayoutConstraint.activate([
            ...
            stackSurfacebarBV.topAnchor.constraint(equalTo: scrollSurfacebarBV.contentLayoutGuide.topAnchor, constant: BaurbstyleStorebarBV.spacebarBV(16, minimumbarBV: 12, maximumbarBV: 22)),
            stackSurfacebarBV.leadingAnchor.constraint(equalTo: scrollSurfacebarBV.frameLayoutGuide.leadingAnchor, constant: sideInsetbarBV),
            stackSurfacebarBV.trailingAnchor.constraint(equalTo: scrollSurfacebarBV.frameLayoutGuide.trailingAnchor, constant: -sideInsetbarBV),
            stackSurfacebarBV.bottomAnchor.constraint(equalTo: scrollSurfacebarBV.contentLayoutGuide.bottomAnchor, constant: -BaurbstyleStorebarBV.spacebarBV(26, minimumbarBV: 20, maximumbarBV: 30))
        ])
    }
    ...
    private func headerbarBV() -> UIView {
        ...
        titleSurfacebarBV.font = BaurbstyleStorebarBV.fontbarBV(26, weight: .heavy)
        titleSurfacebarBV.textColor = .black
        titleSurfacebarBV.textAlignment = .center
        BaurbstyleStorebarBV.labelFitbarBV(titleSurfacebarBV, factorbarBV: 0.72, linesbarBV: 1)
        ...
        NSLayoutConstraint.activate([
            headerSurfacebarBV.heightAnchor.constraint(equalToConstant: BaurbstyleStorebarBV.metricbarBV(52, minimumbarBV: 46, maximumbarBV: 56)),
    ...
    private func searchCardbarBV() -> UIView {
        ...
        fieldSurfacebarBV.font = BaurbstyleStorebarBV.fontbarBV(17, weight: .semibold)
        ...
        rowSurfacebarBV.axis = .horizontal
        rowSurfacebarBV.alignment = .center
        rowSurfacebarBV.spacing = BaurbstyleStorebarBV.metricbarBV(12, minimumbarBV: 10, maximumbarBV: 14)
        cardSurfacebarBV.addSubview(rowSurfacebarBV)
        rowSurfacebarBV.translatesAutoresizingMaskIntoConstraints = false

        NSLayoutConstraint.activate([
            cardSurfacebarBV.heightAnchor.constraint(equalToConstant: BaurbstyleStorebarBV.controlbarBV(58)),
            iconSurfacebarBV.widthAnchor.constraint(equalToConstant: BaurbstyleStorebarBV.metricbarBV(22, minimumbarBV: 20, maximumbarBV: 24)),
            iconSurfacebarBV.heightAnchor.constraint(equalToConstant: BaurbstyleStorebarBV.metricbarBV(22, minimumbarBV: 20, maximumbarBV: 24)),
            rowSurfacebarBV.leadingAnchor.constraint(equalTo: cardSurfacebarBV.leadingAnchor, constant: BaurbstyleStorebarBV.metricbarBV(18, minimumbarBV: 16, maximumbarBV: 20)),
            rowSurfacebarBV.trailingAnchor.constraint(equalTo: cardSurfacebarBV.trailingAnchor, constant: -BaurbstyleStorebarBV.metricbarBV(18, minimumbarBV: 16, maximumbarBV: 20)),
    ...
    private func resultCardbarBV() -> UIView {
        ...
        titleSurfacebarBV.font = BaurbstyleStorebarBV.fontbarBV(14, weight: .heavy)
        ...
        resultStackbarBV.spacing = BaurbstyleStorebarBV.spacebarBV(10, minimumbarBV: 8, maximumbarBV: 12)

        let stackbarBV = UIStackView(arrangedSubviews: [titleSurfacebarBV, resultStackbarBV])
        stackbarBV.axis = .vertical
        stackbarBV.spacing = BaurbstyleStorebarBV.spacebarBV(14, minimumbarBV: 12, maximumbarBV: 18)
        cardSurfacebarBV.addSubview(stackbarBV)
        stackbarBV.translatesAutoresizingMaskIntoConstraints = false
        NSLayoutConstraint.activate([
            stackbarBV.topAnchor.constraint(equalTo: cardSurfacebarBV.topAnchor, constant: BaurbstyleStorebarBV.spacebarBV(18, minimumbarBV: 16, maximumbarBV: 22)),
            stackbarBV.leadingAnchor.constraint(equalTo: cardSurfacebarBV.leadingAnchor, constant: BaurbstyleStorebarBV.metricbarBV(16, minimumbarBV: 14, maximumbarBV: 18)),
            stackbarBV.trailingAnchor.constraint(equalTo: cardSurfacebarBV.trailingAnchor, constant: -BaurbstyleStorebarBV.metricbarBV(16, minimumbarBV: 14, maximumbarBV: 18)),
            stackbarBV.bottomAnchor.constraint(equalTo: cardSurfacebarBV.bottomAnchor, constant: -BaurbstyleStorebarBV.spacebarBV(18, minimumbarBV: 16, maximumbarBV: 22))
        ])
        return cardSurfacebarBV
    }
    ...
    private func resultRowbarBV(_ threadbarBV: threadFixturebarBV) -> UIControl {
        ...
        rowSurfacebarBV.addAction(UIAction { [weak self] _ in
            guard let self else { return }
            self.navigationController?.pushViewController(BaurbthreadPagebarBV(store: self.storebarBV, thread: threadbarBV), animated: true)
        }, for: .touchUpInside)
        ...
        let avatarSurfacebarBV = avatarSurfacebarBV(initial: avatarTextbarBV, color: threadbarBV.smallGroupFlag ? BaurbstyleStorebarBV.mint : BaurbstyleStorebarBV.purple)
        avatarSurfacebarBV.font = BaurbstyleStorebarBV.fontbarBV(18, weight: .heavy)

        let titleSurfacebarBV = UILabel()
        titleSurfacebarBV.text = threadbarBV.threadTitlebarBV
        titleSurfacebarBV.font = BaurbstyleStorebarBV.fontbarBV(17, weight: .heavy)
        titleSurfacebarBV.textColor = .black
        BaurbstyleStorebarBV.labelFitbarBV(titleSurfacebarBV, factorbarBV: 0.72, linesbarBV: 1)

        let previewSurfacebarBV = UILabel()
        previewSurfacebarBV.text = storebarBV.previewTextbarBV(for: threadbarBV)
        previewSurfacebarBV.font = BaurbstyleStorebarBV.fontbarBV(14, weight: .regular)
        previewSurfacebarBV.textColor = BaurbstyleStorebarBV.mutedText
        BaurbstyleStorebarBV.labelFitbarBV(previewSurfacebarBV, factorbarBV: 0.72, linesbarBV: 2)
        ...
        typeSurfacebarBV.font = BaurbstyleStorebarBV.fontbarBV(12, weight: .heavy)
        typeSurfacebarBV.textColor = threadbarBV.smallGroupFlag ? BaurbstyleStorebarBV.purple : BaurbstyleStorebarBV.blue
        ...
        BaurbstyleStorebarBV.labelFitbarBV(typeSurfacebarBV, factorbarBV: 0.68, linesbarBV: 1)
        ...
        rowStackbarBV.spacing = BaurbstyleStorebarBV.metricbarBV(12, minimumbarBV: 10, maximumbarBV: 14)
        rowSurfacebarBV.addSubview(rowStackbarBV)
        rowStackbarBV.translatesAutoresizingMaskIntoConstraints = false

        let avatarSizebarBV = BaurbstyleStorebarBV.metricbarBV(44, minimumbarBV: 40, maximumbarBV: 48)
        NSLayoutConstraint.activate([
            rowSurfacebarBV.heightAnchor.constraint(greaterThanOrEqualToConstant: BaurbstyleStorebarBV.metricbarBV(74, minimumbarBV: 66, maximumbarBV: 82)),
            avatarSurfacebarBV.widthAnchor.constraint(equalToConstant: avatarSizebarBV),
            avatarSurfacebarBV.heightAnchor.constraint(equalToConstant: avatarSizebarBV),
            typeSurfacebarBV.widthAnchor.constraint(greaterThanOrEqualToConstant: BaurbstyleStorebarBV.metricbarBV(64, minimumbarBV: 56, maximumbarBV: 70)),
            typeSurfacebarBV.heightAnchor.constraint(equalToConstant: BaurbstyleStorebarBV.metricbarBV(28, minimumbarBV: 26, maximumbarBV: 30)),
            rowStackbarBV.topAnchor.constraint(equalTo: rowSurfacebarBV.topAnchor, constant: BaurbstyleStorebarBV.spacebarBV(12, minimumbarBV: 10, maximumbarBV: 14)),
            rowStackbarBV.leadingAnchor.constraint(equalTo: rowSurfacebarBV.leadingAnchor, constant: BaurbstyleStorebarBV.metricbarBV(12, minimumbarBV: 10, maximumbarBV: 14)),
            rowStackbarBV.trailingAnchor.constraint(equalTo: rowSurfacebarBV.trailingAnchor, constant: -BaurbstyleStorebarBV.metricbarBV(12, minimumbarBV: 10, maximumbarBV: 14)),
            rowStackbarBV.bottomAnchor.constraint(equalTo: rowSurfacebarBV.bottomAnchor, constant: -BaurbstyleStorebarBV.spacebarBV(12, minimumbarBV: 10, maximumbarBV: 14))
        ])
        return rowSurfacebarBV
    }
    ...
    private func emptyStatebarBV(titlebarBV: String, messagebarBV: String) -> UIView {
        ...
        iconSurfacebarBV.tintColor = BaurbstyleStorebarBV.purple
        iconSurfacebarBV.contentMode = .scaleAspectFit
        ...
        titleSurfacebarBV.font = BaurbstyleStorebarBV.fontbarBV(18, weight: .heavy)
        titleSurfacebarBV.textAlignment = .center
        BaurbstyleStorebarBV.labelFitbarBV(titleSurfacebarBV, factorbarBV: 0.72, linesbarBV: 0)

        let messageSurfacebarBV = UILabel()
        messageSurfacebarBV.text = messagebarBV
        messageSurfacebarBV.font = BaurbstyleStorebarBV.fontbarBV(15, weight: .regular)
        messageSurfacebarBV.textColor = BaurbstyleStorebarBV.mutedText
        messageSurfacebarBV.textAlignment = .center
        BaurbstyleStorebarBV.labelFitbarBV(messageSurfacebarBV, factorbarBV: 0.72, linesbarBV: 0)
        ...
        stackbarBV.spacing = BaurbstyleStorebarBV.spacebarBV(10, minimumbarBV: 8, maximumbarBV: 12)
        surfacebarBV.addSubview(stackbarBV)
        stackbarBV.translatesAutoresizingMaskIntoConstraints = false
        NSLayoutConstraint.activate([
            surfacebarBV.heightAnchor.constraint(greaterThanOrEqualToConstant: BaurbstyleStorebarBV.metricbarBV(170, minimumbarBV: 140, maximumbarBV: 190)),
            iconSurfacebarBV.widthAnchor.constraint(equalToConstant: BaurbstyleStorebarBV.metricbarBV(34, minimumbarBV: 30, maximumbarBV: 38)),
            iconSurfacebarBV.heightAnchor.constraint(equalToConstant: BaurbstyleStorebarBV.metricbarBV(34, minimumbarBV: 30, maximumbarBV: 38)),
    ...
    func textFieldShouldReturn(_ textField: UITextField) -> Bool {
        ...
        if let threadbarBV = visibleThreadsbarBV.first {
            navigationController?.pushViewController(BaurbthreadPagebarBV(store: storebarBV, thread: threadbarBV), animated: true)
        }
        return true
    }
...
private final class homeNotificationSurfacebarBV: barbCanvasbarBV {
    ...
    private func configureSurfacebarBV() {
        ...
        stackSurfacebarBV.translatesAutoresizingMaskIntoConstraints = false
        stackSurfacebarBV.axis = .vertical
        stackSurfacebarBV.spacing = BaurbstyleStorebarBV.spacebarBV(22, minimumbarBV: 18, maximumbarBV: 26)
        stackSurfacebarBV.addArrangedSubview(headerbarBV())
    ...
    private func emptyCardbarBV() -> UIView {
        ...
        iconShellbarBV.layer.cornerRadius = BaurbstyleStorebarBV.metricbarBV(34, minimumbarBV: 30, maximumbarBV: 36)
        ...
        titleSurfacebarBV.font = BaurbstyleStorebarBV.fontbarBV(24, weight: .heavy)
        titleSurfacebarBV.textAlignment = .center
        titleSurfacebarBV.textColor = .black
        BaurbstyleStorebarBV.labelFitbarBV(titleSurfacebarBV, factorbarBV: 0.72, linesbarBV: 0)
        ...
        messageSurfacebarBV.font = BaurbstyleStorebarBV.fontbarBV(16, weight: .regular)
        messageSurfacebarBV.textColor = BaurbstyleStorebarBV.mutedText
        messageSurfacebarBV.textAlignment = .center
        BaurbstyleStorebarBV.labelFitbarBV(messageSurfacebarBV, factorbarBV: 0.72, linesbarBV: 0)
        ...
        cardSurfacebarBV.addSubview(stackbarBV)
        stackbarBV.translatesAutoresizingMaskIntoConstraints = false
        let iconSizebarBV = BaurbstyleStorebarBV.metricbarBV(68, minimumbarBV: 60, maximumbarBV: 72)
        NSLayoutConstraint.activate([
            cardSurfacebarBV.heightAnchor.constraint(greaterThanOrEqualToConstant: BaurbstyleStorebarBV.metricbarBV(310, minimumbarBV: 250, maximumbarBV: 340)),
            ...
            iconSurfacebarBV.widthAnchor.constraint(equalToConstant: BaurbstyleStorebarBV.metricbarBV(30, minimumbarBV: 26, maximumbarBV: 34)),
            iconSurfacebarBV.heightAnchor.constraint(equalToConstant: BaurbstyleStorebarBV.metricbarBV(30, minimumbarBV: 26, maximumbarBV: 34)),
            stackbarBV.leadingAnchor.constraint(equalTo: cardSurfacebarBV.leadingAnchor, constant: BaurbstyleStorebarBV.metricbarBV(20, minimumbarBV: 16, maximumbarBV: 24)),
            stackbarBV.trailingAnchor.constraint(equalTo: cardSurfacebarBV.trailingAnchor, constant: -BaurbstyleStorebarBV.metricbarBV(20, minimumbarBV: 16, maximumbarBV: 24)),
