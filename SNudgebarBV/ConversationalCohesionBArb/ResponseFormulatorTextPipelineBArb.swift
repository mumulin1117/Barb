...
final class ResponseFormulatorTextPipelineBArb: NSObject {
    ...
    func responseFormulatorPostBArb(
        ...
        responseFormulatorRequestBArb.setValue(Locale.current.language.languageCode?.identifier ?? "", forHTTPHeaderField: String(replySuggestionGlyphsBArb: [54, 59, 52, 61, 47, 59, 61, 63]))
